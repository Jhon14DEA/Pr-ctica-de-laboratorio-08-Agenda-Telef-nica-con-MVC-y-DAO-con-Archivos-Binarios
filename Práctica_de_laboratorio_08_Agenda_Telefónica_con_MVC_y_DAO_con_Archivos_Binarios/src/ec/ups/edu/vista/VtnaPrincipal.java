...
public class VtnaPrincipal extends javax.swing.JFrame {
    ...
    private VtnaInicioSesion ventanaInicioSesion;
    private VtnaRegistrarUsuario ventanaRegistrarUsuario;
    private VtnaGestionTelefono ventanaGestionTelefonos;
    private VtnaBuscarUsuario ventanaListar;
    private VtnaGestionUsuario ventanaGestionUsuario;
    ...
    public VtnaPrincipal() {
        ...
        ventanaInicioSesion = new VtnaInicioSesion(controladorU, this);
        ventanaRegistrarUsuario = new VtnaRegistrarUsuario(controladorU);
        ventanaGestionTelefonos = new VtnaGestionTelefono(controladorU);
        ventanaListar = new VtnaBuscarUsuario(controladorU);
        ventanaGestionUsuario = new VtnaGestionUsuario(controladorU);
